        ...
        {currentStudents.map((student) => (
          ...
          >
            <div className="relative h-64 overflow-hidden">
              <img
                src={student.photo.startsWith('/') ? `${import.meta.env.BASE_URL}${student.photo.slice(1)}` : student.photo}
                alt={student.name}
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center space-x-3">
                <img
                  src={student.companyLogo.startsWith('/') ? `${import.meta.env.BASE_URL}${student.companyLogo.slice(1)}` : student.companyLogo}
