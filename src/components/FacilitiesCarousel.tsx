        ...
        {enhancedFacilities.slice(currentIndex, currentIndex + itemsPerPage).map((facility) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <button className="w-full bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold py-2 rounded-lg transition-all duration-300 hover:scale-105 text-sm mt-auto">
                Explore Facility
              </button>
            </div>
          </div>
