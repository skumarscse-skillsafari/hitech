...
const TeachingMethodologies: React.FC<TeachingMethodologiesProps> = ({
  ...
  const displayedMethodologies = showAll
    ? methodologies
    : methodologies.slice(0, 6);

  const getMethodologyDescription = (methodology: string) => {
    const descriptions: { [key: string]: string } = {
      'Project-Based Learning':
        'Students work on real-world projects to apply theoretical knowledge practically.',
      'Industry-Integrated Curriculum':
        'Curriculum designed with industry input to meet current market demands.',
      'Hands-on Laboratory Sessions':
        'Practical sessions in well-equipped labs for experiential learning.',
      'Research-Oriented Teaching':
        'Teaching methodology that encourages research and innovation.',
      'Collaborative Learning':
        'Group-based learning to enhance teamwork and communication skills.',
      'Case Study Method':
        'Real-world case studies to understand practical applications.',
      'Simulation-Based Learning':
        'Using simulations to create realistic learning environments.',
      'Hardware-in-Loop Testing':
        'Testing with actual hardware components for practical understanding.',
      'Industry Projects':
        'Live projects from industry partners for real-world experience.',
      'Research-Based Learning':
        'Learning through active research and investigation.',
      ...
      'Workshop-Based Training':
        'Hands-on training in specialized workshops.',
      'Field-Based Learning':
        'Learning through field visits and practical exposure.',
      'Site Visits and Practical Training':
        'Regular visits to industry sites for practical exposure.',
      'Software-Based Design':
        'Using advanced software tools for design and analysis.',
      'Industry Collaboration':
        'Direct collaboration with industry for enhanced learning.',
    };

    return (
      descriptions[methodology] ||
      'Innovative teaching approach for enhanced learning experience.'
    );
  };
    ...
    <div className="bg-white p-8 rounded-2xl shadow-lg">
        ...
        {displayedMethodologies.map((methodology, index) => {
          ...
          return (
            <div
              ...
              onMouseEnter={() => {
                if (window.innerWidth >= 768) setHoveredCard(index);
              }}
              onMouseLeave={() => {
              ...
              onClick={() => {
                if (window.innerWidth < 768) {
                  setHoveredCard(isActive ? null : index);
                }
              }}
            >
              ...
              <div
                className={`mt-4 flex items-center text-xs font-medium transition-all duration-300 ${
                  isActive
      ...
      {methodologies.length > 6 && (
        <div className="text-center">
          ...
          >
            <span>
              {showAll ? 'Show Less' : `View All ${methodologies.length} Methodologies`}
            </span>
      ...
      <div className="mt-8 bg-yellow-50 p-6 rounded-xl border border-yellow-200">
        ...
        <p className="text-gray-700 leading-relaxed">
          Our innovative teaching methodologies in {departmentName} are designed to bridge the gap
          between theoretical knowledge and practical application. These approaches ensure our
          students are industry-ready and equipped with the skills needed for tomorrow's challenges.
        </p>
      </div>
    </div>
  );
