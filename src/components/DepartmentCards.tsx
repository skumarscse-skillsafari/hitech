    ...
    <section id="departments" className="py-10 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {departments.map((dept) => {
            ...
            return (
              <div
                key={dept.id}
                className="bg-white w-[90%] sm:w-full mx-auto rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden group hover:-translate-y-2"
              >
                {/* Department Image */}
                <div className="relative min-h-[280px] sm:h-48 overflow-hidden">
                  <img
                    src={dept.image}
                    alt={dept.name}
                ...
                <div className="p-6 sm:p-8 space-y-6">
                  ...
                  <Link
                    ...
                    className="w-full bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold py-3 rounded-lg transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2 group/btn text-base"
                  >
        ...
        <div className="text-center mt-12">
          <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg inline-block">
