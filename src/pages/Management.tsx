...
const values = [
  {
    icon: Lightbulb,
    title: "Innovation",
    description: "We promote creative thinking and inventive solutions."
  },
  {
    icon: Users,
    title: "Inclusivity",
    description: "Our doors are open to students from all backgrounds."
  },
  {
    icon: Star,
    title: "Excellence",
  ...
  },
  {
    icon: Heart,
    title: "Compassion",
    description: "We care deeply about our students and community."
  },
];
...
const achievements = [
  {
    year: "1992",
    title: "Foundation",
    description: "Established Hindusthan Educational and Charitable Trust."
  },
  {
    year: "2000",
    title: "First Engineering College",
    description: "Launched technical education with HIT."
  },
  {
    year: "2010",
    title: "National Recognition",
    description: "Received Lifetime Education Achievement Award."
  },
  {
    year: "2020",
    title: "Digital Expansion",
    description: "Introduced modern e-learning initiatives."
  }
];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Hero Section */}
        <SectionWrapper lazy lazyHeight="400px" lazyDelay={300} className="-mt-4">
              ...
              return (
                <div key={leader.id} className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                  ...
                  <div className={`relative ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                    <div className="p-8 rounded-2xl border-2 hover:shadow-xl transition-all duration-300">
