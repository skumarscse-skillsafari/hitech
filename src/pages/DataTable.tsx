...
const sectionDescriptions: Record<string, string> = {
  ...
  fac_nptel: "Faculty participation in NPTEL courses for professional development and continuous learning.",
  fac_patents: "Patents filed or granted, demonstrating innovation and practical application of research outcomes.",
  fac_participation: "Faculty participation in workshops, seminars, and Faculty Development Programs (FDPs) aimed at skill enhancement and academic growth.",
