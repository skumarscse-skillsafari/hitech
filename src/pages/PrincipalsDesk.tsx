    ...
    <div className="mt-40 bg-white">
      ...
      <div className="relative w-full h-[300px] md:h-[400px] bg-gradient-to-br from-yellow-100 to-yellow-300 flex items-center justify-center overflow-hidden rounded-xl shadow-inner">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl mt-3 text-gray-700 font-medium">Dr. C. Natarajan — Leading with Purpose & Passion</p>
        </div>
      </div>

      {/* Floating Profile Card */}
      <div className="-mt-20 max-w-5xl mx-auto bg-white rounded-2xl p-6 shadow-xl border border-yellow-300 flex flex-col md:flex-row gap-6 items-center mb-12 z-20 relative">
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-8 py-8 space-y-8 text-[17px] text-gray-800 text-justify leading-relaxed">
        <div className="bg-white rounded-xl p-6 border-l-4 border-yellow-500 shadow-sm relative">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-200 col-span-2">
